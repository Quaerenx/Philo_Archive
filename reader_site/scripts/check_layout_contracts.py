...
def check_notes_ui() -> None:
    ...
    for needle in [
        ...
        ">원문 읽기</a>",
        ">노트 수정</button>",
        'title="${escapeHtml(editSaveLabel)}"',
        'aria-label="${escapeHtml(editCancelLabel)}"',
...
def check_translations_ui() -> None:
    ...
    for needle in [
        ...
        "openFirstCommentary: inReviewQueue || inSavedReading",
...
def check_work_source_bundle_ui() -> None:
    ...
    for needle in [
        ...
        "function collapseStudyPanelToSource",
    ...
    require("<small>" not in work_markup, "rendering/work_markup.py should keep concept entries as compact search links")
    ...
    require(".concept-list small" not in css, "assets/reader-work.css should not style visible concept descriptions")
