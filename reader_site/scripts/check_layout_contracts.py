...
def check_translations_ui() -> None:
    ...
    for needle in [
        "/assets/notes.css?v=notes10",
        "/assets/translations.css?v=trans2",
        "/assets/translations.js?v=trans4",
...
def check_work_source_bundle_ui() -> None:
    ...
    for needle in [
        ...
        "Start the local translator, then retry this sentence.",
