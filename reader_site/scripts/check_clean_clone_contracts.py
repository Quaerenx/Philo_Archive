...
REQUIRED_FILES = [
    ...
    "reader_site/assets/reader-work-app.js",
    "reader_site/assets/reader-work-controls.css",
    "reader_site/assets/reader-work-notes.css",
    "reader_site/assets/reader-work-notes.js",
    "reader_site/assets/reader-work-panel.js",
    "reader_site/assets/reader-work-responsive.css",
    "reader_site/assets/reader-work-runtime.js",
    "reader_site/assets/reader-work-sentences.js",
    "reader_site/assets/reader-work-source.css",
    "reader_site/assets/reader-work-study.css",
    "reader_site/assets/reader-work-translation.css",
    "reader_site/assets/reader-work-translation.js",
    "reader_site/run_reader_with_gemma.ps1",
    "reader_site/scripts/rebuild_all.py",
    "reader_site/scripts/build_archive_catalog.py",
    "reader_site/scripts/build_segment_offset_index.py",
    ...
    "reader_site/scripts/check_work_chunk_contracts.py",
    ...
    "reader_site/scripts/check_translation_goldset.py",
    "reader_site/scripts/check_segment_offset_contracts.py",
    ...
    "reader_site/services/translation_profiles.py",
    "reader_site/scripts/check_translation_quality_regressions.py",
    "reader_site/services/segment_offsets.py",
    "reader_site/services/source_targets.py",
    "reader_site/services/work_chunks.py",
    ...
    "reader_site/docs/translation_quality_evaluation.md",
]
...
SOURCE_LIGHT_COMMANDS = [
    ...
    [sys.executable, "scripts/check_translation_goldset.py"],
...
def check_runner_script_contracts(repo: Path = REPO) -> None:
    ...
    for snippet in [
        ...
        "Reader browsing, search, and notes remain available.",
        "Write-GemmaRuntimeState",
        "Wait-ReaderReady",
        "Wait-OwnedProcesses",
        "PHILO_GEMMA_STATE_PATH",
        '[int]$GemmaPort = 9999',
        '[switch]$StopGemmaWithReader',
        "Get-LegacyGemmaListenerPorts",
        "Leaving shared Gemma runtime process",
        "Open Philo Archive:",
        '[string]$ReaderHost = "127.0.0.1"',
        "This PC: http://${HostName}:${Port}/",
        "ReaderHost must be loopback-only",
        "Test-PortLoopbackOnly",
        "has a non-loopback listener",
