...
def run_contracts() -> None:
    ...
    try:
        ...
        notes_markdown = export_notes_markdown(read_all_notes([CORPUS_ID]))
        require("Source:" in notes_markdown, "markdown source export failed")
        require("Tags: edited" in notes_markdown, "markdown tags export failed")
        require("Review:" not in notes_markdown, "notes markdown should hide review-state metadata")
        require("Reviewed:" not in notes_markdown, "notes markdown should hide reviewed timestamps")
        require("Created:" not in notes_markdown, "notes markdown should hide created timestamps")
        require("Updated:" not in notes_markdown, "notes markdown should hide updated timestamps")
        ...
        require(groups[0]["summary"].startswith("1 note"), "study group summary failed")
        ...
        require("Tags: edited" in study_markdown, "study markdown note tags failed")
        require("Reviewed:" not in study_markdown, "study markdown should hide reviewed timestamps")
        require("Reviewed range" not in study_markdown, "study markdown should hide reviewed ranges")
